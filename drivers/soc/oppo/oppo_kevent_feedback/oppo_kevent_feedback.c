...
int upload_mm_kevent_feedback_data(enum OPPO_MM_DIRVER_FB_EVENT_MODULE module, unsigned char *payload) {
	...
	//mutex_lock(&mm_kevent_lock); //GaoTing.Gan del, don't need lock
