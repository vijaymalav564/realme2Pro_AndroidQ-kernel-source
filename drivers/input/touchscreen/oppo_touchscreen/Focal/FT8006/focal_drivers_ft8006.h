...
struct focal_register
{
    ...
    uint8_t FTS_REG_EDGESCREEN_Y1;      /*set edge screen up position*/
    uint8_t FTS_REG_EDGESCREEN_Y2;      /*set edge screen down position*/
    uint8_t FTS_REG_EDGESCREEN_DIR;     /*set edge screen down direction*/
};

struct grip_rejction {
    int ver_edgescreen_y1;
    int ver_edgescreen_y2;
    int edgescreen_switch;
};

enum grip_bit {
    PORTRAIT_GRIP_BIT,
    LANDSCAPE_GRIP_BIT,
    LANDSCAPE_ELIMINATION_BIT,
    PORTRAIT_EDGE_SCREEN_BIT,
};
