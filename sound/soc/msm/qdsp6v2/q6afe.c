...
int afe_dsm_get_libary_info(uint8_t* payload)
{
	return afe_dsm_get_params(DSM_TX_PORT_ID, AFE_MODULE_DSM_TX, AFE_PARAM_ID_DSM_INFO,  (int8_t*)payload, sizeof(uint32_t)*8);
}
